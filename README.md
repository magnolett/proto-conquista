...
| **Scroll** · **botão do MEIO** · clique no **minimapa** | Zoom (ancorado no cursor) · arrastar a câmera · teleportar a câmera |
| **E** (no menu) | Quantidade de IAs rivais: 1 (1v1 espelhado) a **3 (FFA, padrão)** |
